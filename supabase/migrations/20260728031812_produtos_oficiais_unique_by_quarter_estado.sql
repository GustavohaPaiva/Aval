-- Allow same fertilizante name across MG and SP for the same quarter
DROP INDEX IF EXISTS public.produtos_oficiais_fornecedor_nome_quarter_unique_idx;

CREATE UNIQUE INDEX IF NOT EXISTS produtos_oficiais_fornecedor_nome_quarter_estado_unique_idx
...
BEGIN
  ...
  LOOP
    ...
    -- Match by fornecedor + nome + quarter + estado so MG and SP coexist
