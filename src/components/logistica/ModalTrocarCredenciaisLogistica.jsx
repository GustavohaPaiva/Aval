...
const FORM_ID = 'form-trocar-credenciais-logistica'

export function ModalTrocarCredenciaisLogistica({
  open,
  userId,
  initialUsuario,
  onClose,
  ...
  async function handleSubmit(e) {
    ...
    if (wantsPassword) {
      ...
      if (
        normalizeDocumentDigits(senha) !== normalizeDocumentDigits(confirmSenha)
      ) {
